...
import { 
  ...
  Mail, MailOpen, Star, Trash2, Clock, Send
} from 'lucide-react';
              ...
              {filteredMessages.length > 0 ? (
                <div className="divide-y divide-border">
                  {filteredMessages.map((message) => (
                    <div 
                      key={message.id}
                      className={`p-4 flex items-start gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 cursor-pointer ${!message.read && folder === 'inbox' ? 'bg-blue-50 dark:bg-blue-900/20' : ''}`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2 mb-1">
                          <h3 className={`font-medium truncate ${!message.read && folder === 'inbox' ? 'text-gray-900 dark:text-gray-100' : 'text-gray-700 dark:text-gray-300'}`}>
                        ...
                        <h4 className={`truncate mb-1 ${!message.read && folder === 'inbox' ? 'font-semibold' : 'font-medium'}`}>
                          {message.subject}
                        </h4>
